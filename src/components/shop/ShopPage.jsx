  ...
  function ShopPage() {
    ...
    const filteredProducts = products.filter((product) => {
      ...
      const collectionMatch = selectedCollection ? product.collection === selectedCollection : true;
    ...
    return (
      <div className="font-sans">
        ...
        <header className="flex justify-between items-center px-10 py-5 border-b">
          <h1 className="text-2xl font-bold">FASCO</h1>
          ...
          <main className="w-3/4">
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex gap-2 mt-2">
                      {product.colors.map((c, idx) => (
                        <div
                          key={idx}
                          className={`${c} w-5 h-5 rounded-full border`}
                        />
                      ))}
                    </div>
                  </div>
            ...
            <div className="flex justify-center gap-2 mt-10">
              {[1, 2, 3].map((page) => (
                <button
                  key={page}
                  className={`px-3 py-1 border-lg rounded cursor-pointer ${page === 1 ? "bg-gray-300 text-white" : "bg-white"}`}
                >
                  {page}
                </button>
              ))}
